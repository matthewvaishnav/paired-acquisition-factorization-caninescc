...
{\LARGE\bfseries External Paired-Scanner Validation of\\
Paired-Acquisition Neural Factorization\\
on Canine Squamous Cell Carcinoma Histopathology\par}
...
\texttt{paired-acquisition-factorization-caninescc}
\end{center}
